...
The `toggle/raw` chart takes a list of Kubernetes resources and
...
```
helm install raw-priority-classes toggle/raw -f raw-priority-classes.yaml
```
...
```
helm install mysecret toggle/raw -f values.yaml
```
